...
CREATE TABLE SIM_contri
  (
    contri_id              INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER ,
    SIM_project_project_id INTEGER
  ) ;
ALTER TABLE SIM_contri ADD CONSTRAINT SIM_contri_PK PRIMARY KEY ( contri_id ) ;
...
ALTER TABLE SIM_contri ADD CONSTRAINT SIM_contri_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;
